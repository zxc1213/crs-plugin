...
- 运行 `node $CLAUDE_REQ_SYS/scripts/requirement-manager/index.js --dashboard`
- 显示需求统计、活跃需求、最近需求列表

**`--list`**：

- 运行 `node $CLAUDE_REQ_SYS/scripts/requirement-manager/index.js --list`
- 列出所有需求及其状态

**`--active`**：

- 运行 `node $CLAUDE_REQ_SYS/scripts/requirement-manager/index.js --active`
