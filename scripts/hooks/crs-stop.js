#!/usr/bin/env node
/**
 * CRS Stop hook (ClaudeCode): sync requirement documents + emit execution summary.
 * 同步自 crs-zcode v1.5.0 hooks/stop.mjs。
 *
 ...
 *     | node scripts/hooks/crs-stop.js
 */
...
try {
  const { loadRules, applyPlaceholders } = await import('../requirement-manager/core/rules.js');
